...
public class DNSHelper {
    ...
    public static <R extends Record> List<R> parseMessage(Message response) throws IOException, DNSException {
        ...
        for(RRset set : answerRRsets) {
            for(Iterator<Record> it = set.rrs(); it.hasNext(); ) {
                Record elem = it.next();
    ...
    public List<String> queryTXT(String host) throws IOException, DNSException {
        ...
        List<Record> records = DNSHelper.parseMessage(response);
